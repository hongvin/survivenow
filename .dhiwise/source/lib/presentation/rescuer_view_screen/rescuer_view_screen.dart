                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Card(
                                                                            ...
                                                                            shape: RoundedRectangleBorder(borderRadius: BorderRadiusStyle.circleBorder105),
                                                                            child: Container(
                                                                                height: getSize(210),
                                                                                width: getSize(210),
                                                                    ...
                                                                    child: Stack(
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                              ...
                                                                              child: Container(height: getVerticalSize(15), width: getHorizontalSize(121), decoration: BoxDecoration(color: ColorConstant.gray100Cc))),
                                                                          Align(
                                                                              alignment: Alignment.bottomCenter,
                                                                              child: Text("msg_map_data_2023_google".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoRegular10))
                                                                        ])),
                                                                Container(
                                                                    width:
                                                                        getHorizontalSize(
                                                                ...
                                                                Container(
                                                                    ...
                                                                    child: Stack(
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                              child: Container(height: getVerticalSize(15), width: getHorizontalSize(94), decoration: BoxDecoration(color: ColorConstant.gray100Cc))),
                                                                          Align(
                                                                              alignment: Alignment.bottomCenter,
                                                                              child: Text("msg_report_a_map_error".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoRegular10))
                                                                        ]))
                                                              ]))
                                                    ]))
                                          ]))),
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              Text("lbl_upload_photo".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRubikRomanBold12.copyWith(letterSpacing: getHorizontalSize(0.12)))
                                                                            ])),
                                                                    Container(
                                                                        margin: getMargin(
                                                                            left:
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                                            children: [
                                                                              Text("msg_submit_your_story".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRubikRomanBold12.copyWith(letterSpacing: getHorizontalSize(0.12)))
                                                                            ]))
                                                                  ]))
                                                        ])))
                                          ])))
