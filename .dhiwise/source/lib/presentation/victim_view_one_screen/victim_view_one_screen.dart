        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: AppbarIconbutton1(
                    ...
                    margin: getMargin(left: 16, top: 4, bottom: 7),
                    onTap: onTapArrowleft2),
                title: AppbarTitle(
                    text: "lbl_earthquake".tr, margin: getMargin(left: 10)),
                actions: [
                  AppbarButton(
                      margin: getMargin(left: 17, right: 17, bottom: 3))
                ]),
            body: Container(
                width: size.width,
                height: size.height,
                padding: getPadding(top: 43, bottom: 100),
                ...
                child: SingleChildScrollView(
                    child: Padding(
                        padding: getPadding(left: 16, top: 10, right: 17),
                        child: Column(
